...
Column(
children: [
_buildDownloadButton("CPS 3000"), // Updated from CPS3000
const SizedBox(height: 20),
_buildDownloadButton("CPS 2500"), // Added/Updated from DPS 2500
const SizedBox(height: 20),
...
backgroundColor: type.startsWith("CPS") ? Colors.green.shade700 : Colors.blue.shade700,
